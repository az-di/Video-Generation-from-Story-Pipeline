...
from editing_evaluation_prompt import editing_eval_prompt
import threading
...
endpoints = [
    os.getenv("IMAGE_ENDPOINT_1"),
    os.getenv("IMAGE_ENDPOINT_2"),
    os.getenv("IMAGE_ENDPOINT_3"),
    os.getenv("IMAGE_ENDPOINT_4")
]
...
input_file=os.path.join(base_path, f"scenes_ch_{chapter}.json")
output_dir = os.path.join(base_path, f"chapter_{chapter}_images")
